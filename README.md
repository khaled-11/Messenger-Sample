...
> **FFMPEG Framework**: The installation is different for each operating system. For windows users, you can read [this article](http://blog.gregzaal.com/how-to-install-ffmpeg-on-windows/) which explains how to set it up.
